...
// Import renderers (will be implemented in later phases)
...
app.post('/generate', async (req, res) => {
  try {
    ...
    // ============================================================
    // TEMPORARY: Generate test slide (will be replaced in Phase 3-4)
    // ============================================================
    ...
    // Add title text
    slide.addText('AIvantage Presentation Generator', {
      x: tokens.spacing.padX,
      y: 2.5,
      w: 13.333 - (tokens.spacing.padX * 2),
      h: 1.0,
      fontSize: 44,
    ...
    // Add subtitle
    slide.addText('Microservice conectado exitosamente', {
      x: tokens.spacing.padX,
      y: 3.6,
      w: 13.333 - (tokens.spacing.padX * 2),
      h: 0.5,
    ...
    // Add info box
    slide.addText(`Slides solicitados: ${slides.length}\nFecha: ${new Date().toLocaleDateString('es-ES')}`, {
      x: tokens.spacing.padX,
      y: 4.5,
      w: 13.333 - (tokens.spacing.padX * 2),
      h: 0.8,
